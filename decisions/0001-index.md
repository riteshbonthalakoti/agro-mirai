...
- `0029-remove-tabular-service-and-rf-models.md` — Deleted the tabular Render service, the crop/irrigation RandomForests, SHAP and training tools; advice is rule-based and runs in the main API.
